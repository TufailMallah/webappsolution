...
function Contact() {
  ...
  return (
    <Fragment>
      ...
      <section>
        <div
          className="container-fluid contact py-6 wow bounceInUp  mt-5 mb-5"
          data-wow-delay="0.1s"
        >
          <div className="col-12 text-center text-light">
            <h1 className="display-5 mb-0">Contact Us </h1>
            <p className="mb-4">
              Get in touch with WebsiteAppSolutions to embark on your journey
                ...
                <div className="col-md-6 col-lg-7 text-light">
                  <form onSubmit={handleSubmit}>
                    <input
                      ...
                      className="w-100 form-control p-3 mb-4 border-primary text-light"
                    ...
                    <textarea
                      ...
                      value={message}
                      onChange={handleChange}
                      className="w-100 form-control mb-4 p-3 border-primary text-light"
                      rows="4"
                      cols="10"
                      placeholder="Your Message"
                    ></textarea>
                    <div
                      style={{ background: "#9604a9", borderRadius: "10px" }}
                    >
                      {isSubmitted && (
                ...
                <div className="col-md-6 col-lg-5 mt-3">
                  <div>
                    ...
                    <div className="d-inline-flex w-100 border border-primary p-4 rounded mb-4 ">
                      <i
                        className="fa fa-envelope text-light"
                        aria-hidden="true"
                      ></i>
                      <div className="">
                        <h4>Mail Us</h4>
                    ...
                    <div className="d-inline-flex w-100 border border-primary p-4 rounded">
                      <i
                        className="fa fa-phone text-light"
                        aria-hidden="true"
                      ></i>
                      <div className="">
                        <h4>Telephone</h4>
