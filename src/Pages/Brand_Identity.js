...
<section class="brandidentity_background" style={{ height: "70vh", display: "flex", alignItems: "center" }}>
    <div className="container">
        <div className="row mt-5">
            <div className="col-12  col-md-11 ">
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                    <h1 style={{ textAlign: "center" }}>Brand Identity</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div className="row mt-2">
              <div className="col-md-6 mb-4">
                <div className="image-container">
                  <img
                    src="/assets/images/brand1.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image mb-3"
                  />
                  <img
                    src="/assets/images/brand5.jpeg"
                    alt="UI/UX Design"
              ...
              <div className="col-md-6 mb-4">
                <div className="image-container">
                  <img
                    src="/assets/images/brand3.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image mb-3"
                  />
                  <img
                    src="/assets/images/brand4.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image"
