...
function UIUX() {
    ...
    return(
        <Fragment>
             ...
             <section class="UIUX_background" style={{ height: "70vh", display: "flex", alignItems: "center" }}>
    <div className="container">
        <div className="row mt-5">
            <div className="col-md-12  col-md-11 ">
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                    <h1 style={{ textAlign: "center" }}>UIUX Desigen</h1>
                </div>
            </div>
        </div>
    </div>
      ...
      <div className="container">
        <div className="row m-5">
          <div className="col-md-12">
            <h1 className="text-center">UI / UX</h1>
          </div>
          <div className="row mt-5 justify-content-center">
            <div className="col-md-8 ">
              <div className="row mb-4 mr-3">
                <div className="col-md-12 custom-bg-1 custom-border-radius p-3 mb-4 ">
                  <h3>Description</h3>
                ...
                <div className="col-md-12 custom-bg-2 custom-border-radius p-3">
            ...
            <div className="row mt-2">
              <div className="col-md-6 mb-4">
                <div className="image-container">
                  <img
                    src="/assets/images/UIUX1.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image mb-3"
                  />
                  <img
                    src="/assets/images/UIUX2.jpeg"
                    alt="UI/UX Design"
              ...
              <div className="col-md-6 mb-4">
                <div className="image-container">
                  <img
                    src="/assets/images/UIUX3.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image mb-3"
                  />
                  <img
                    src="/assets/images/UIUX4.jpeg"
                    alt="UI/UX Design"
                    className="img-fluid custom-image"
                  />
                </div>
