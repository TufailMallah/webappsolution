...
<section className="hero">
                ...
                <div className="swiper-container hero-slider">
                 ...
                 <div className="swiper-slide slide-content d-flex align-items-center">
                            <div className="single-slide">
                                <h1 data-aos="fade-right" data-aos-delay="200">WEBSITE APP Sollution
                                </h1>
                                <p data-aos="fade-right" data-aos-delay="600">"Step into a realm of unparalleled IT expertise,where our dedication to excellence is not<br/>
 just a promise but a commitment to building the perfect technological foundation for<br/>
  your business success. Your journey to achievement starts here."
                                </p>
                                <Link data-aos="fade-right" data-aos-delay="900" href="#" className="btn btn-primary">See
                                    More</Link>
                                <Link data-aos="fade-right" data-aos-delay="900" href="#" className="btn btn-primary">Get
                                    Now</Link>
                            </div>
                        </div> 
                        <div className="swiper-slide slide-content d-flex align-items-center">
 ...
 just a promise but a commitment to building the perfect technological foundation for<br/>
  your business success. Your journey to achievement starts here."
        ...
        <span className="arr-left"><i className="fa fa-angle-left mb-5"></i></span>
        <span className="arr-right"><i className="fa fa-angle-right mb-5"></i></span>
    </div>
    ...
    <div className="container ">
        <div className="cta-content d-xl-flex align-items-center justify-content-around text-center text-xl-left ">
            ...
            <div className="subscribe-btn" data-aos="fade-left" data-aos-delay="400" data-aos-offset="0">
                <Link href="#" className="btn btn-primary">Join Newsletter</Link>
            </div>
        </div>
    </div>
</section>
    ...
    <div className="container">
        ...
        <div className="container-fluid">
            <div className="row justify-content-center">
              <div className="col-sm-6 col-lg-3 media_body m-1" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
                    <div className="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                      {/* <img className="mr-4" src="assets/images/service1.png" alt="Web Development" />  */}
                        <div className="media-body">
                            ...
                            <p>Your vision fuels our creativity. Share your project requirements to transform ideas into reality. Our experienced team listens, understands, and collaborates closely. Let's begin this journey together – share your project details, and we'll craft a digital masterpiece.</p>
                        </div>
                </div>
                    ...
                    <div className="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                      {/* <img className="mr-4" src="assets/images/service1.png" alt="Web Development" />  */}
                        <div className="media-body ">
                            ...
                            <p>Embark on a creative journey with us. Our design team is ready to transform your ideas into stunning visuals. Committed to excellence, we create designs that exceed expectations. Let's collaborate and bring your brand to life with innovative concepts and captivating aesthetics.</p>
                    ...
                    <div className="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                     {/* <img className="mr-4" src="assets/images/service1.png" alt="Web Development" /> */}
                        <div className="media-body ">
                            ...
                            <p>At WebsiteAppSolutions, we specialize in transforming visions into reality through our development expertise. We focus on crafting cutting-edge digital solutions tailored to exceed your expectations, ensuring your digital presence stands out.</p>
        ...
        <div className="row">
            <div className="col-md-12">
                <div className="title text-center">
                    ...
                    <p className="text-white">We take pride in our work. Our services are crafted to elevate your business and transform your ideas into digital realities that stand out.</p>
                </div>
            </div>
            <div className="col-lg-6 ">
                <div className="single-rpost d-sm-flex align-items-center" data-aos="fade-right"
                    ...
                    <div className="post-content text-sm-right">
                        ...
                        <h3><Link href="#">Web Development</Link></h3>
                        <p>WebsiteAppSolutions specializes in crafting exceptional websites designed for online success. With our expertise in development, innovation, and client-centric solutions, we ensure that your digital presence stands out and drives meaningful results.</p>
            ...
            <div className="col-lg-6">
                <div className="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-duration="800">
                    ...
                    <div className="post-content">
                        ...
                        <p>WebsiteAppSolutions: Elevate your brand with our expert application development services. We specialize in delivering tailored innovation with a commitment to excellence, ensuring your digital solutions stand out in today's competitive landscape.</p>
                        <Link className="post-btn" to="/app_development"><i className="fa fa-arrow-right"></i></Link>
                    </div>
                </div>
            </div>
            <div className="col-lg-6">
                <div className="single-rpost d-sm-flex align-items-center" data-aos="fade-right" data-aos-delay="200"
                    ...
                    <div className="post-content text-sm-right">
                        <time datetime="2019-04-06T13:53">15 Oct, 2019</time>
                        <h3><Link href="#">UI/UX Design</Link></h3>
                        <p>WebsiteAppSolutions: enhances user experience (UX) through a seamless blend of aesthetic design and usability, ensuring engaging interactions that delight your audience at every turn.</p>
            ...
            <div className="col-lg-6">
                <div className="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                    ...
                    <div className="post-content">
                        <time datetime="2019-04-06T13:53">15 Oct, 2019</time>
                        <h3><Link href="#">Graphic Desiging</Link></h3>
                        <p>WebsiteAppSolutions: Where imagination merges with design excellence, sculpting captivating brand visuals that establish an enduring presence in the digital realm.</p>
                        <Link className="post-btn" to="/graphic_design"><i className="fa fa-arrow-right"></i></Link>
                    </div>
                </div>
            </div>
        </div>
...
<section className="trust">
    <div className="container">
        <div className="row ">
            <div className=" col-md-6" data-aos="fade-right" data-aos-delay="200" data-aos-duration="800">
                <div className="title">
                    <h6 className="title-primary">about </h6>
                    <h1>Our Portfolio.</h1>
                </div>
                <p>"Our diverse portfolio reflects excellence in digital solutions, from websites to mobile apps and social media strategies. Explore how we craft impactful experiences for businesses like yours."
                </p>
            ...
            <div className="col-xl-6 gallery">
                <div className="row no-gutters h-100" id="lightgallery">
                    <Link href="https://lorempixel.com/600/400/" className="w-50 h-100 gal-img" data-aos="fade-up"
                        data-aos-delay="200" data-aos-duration="400">
                        <img className="img-fluid" src="/assets/images/UIUX.jpg" alt="Gallery 1" />
                        <i className="fa fa-caret-right"></i>
                    </Link>
                    <Link href="https://lorempixel.com/600/400/" className="w-50 h-50 gal-img" data-aos="fade-up"
                        data-aos-delay="400" data-aos-duration="600">
                        <img className="img-fluid" src="/assets/images/graphic.jpg" alt="Gallery 2" />
                        <i className="fa fa-caret-right"></i>
                    </Link>
                    <Link href="https://lorempixel.com/600/400/" className="w-50 h-50 gal-img gal-img3" data-aos="fade-up"
                        data-aos-delay="0" data-aos-duration="600">
                        <img className="img-fluid" src="/assets/images/brandidentity.jpg" alt="Gallery 3" />
                        <i className="fa fa-caret-right"></i>
                    </Link>
                </div>
            </div>
...
<section className="pricing-table">
        ...
        <div className="row no-gutters ">
            <div className="col-md-4">
                <div className="single-pricing text-center" data-aos="fade-up" data-aos-delay="0"
                    ...
                    <Link href="#" className="btn btn-primary mb-3">Buy Now</Link>
            ...
            <div className="col-md-4">
    <div className="single-pricing text-center" data-aos="fade-up" data-aos-delay="600"
        data-aos-duration="600">
        <span>Monthly</span>
        <h2>Premium Plan</h2>
        ...
        <svg viewBox="0 0 170 193">
           ...
           <div className="col-md-4" data-aos="fade-up" data-aos-delay="300" data-aos-duration="600">
    <div className="single-pricing text-center">
        ...
        <p>Integration of additional features like galleries or sliders</p>
                    ...
                    <div className="swiper-slide text-center">
                        <div className="row">
                            <div className="offset-lg-1 col-lg-10">
                                <div className="test-img" data-aos="fade-up" data-aos-delay="0" data-aos-offset="0">
                                <img src="assets/images/test1.png" alt="Testimonial 1" /></div>
