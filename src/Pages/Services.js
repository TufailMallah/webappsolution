...
function Services() {
    ...
    <div class="container">
        <div class="text-center wow bounceInUp animate__animated animate__fadeIn" data-wow-delay="0.1s">
            <h1 class="display-5 mb-5">Our Services</h1>
            <p>At WebsiteAppSolutions, we take immense pride in our work. Our comprehensive range of services is meticulously crafted to elevate your business to new heights. We transform your ideas into standout digital realities, ensuring that your online presence not only meets but exceeds your expectations. By leveraging cutting-edge technologies and innovative design principles, we create digital solutions that are both functional and visually captivating. Let us help you bring your vision to life and make your digital footprint truly remarkable.</p>
        </div>
        <div class="row g-4 mb-3 mt-5">
            <div class="col-lg-4 col-md-6 col-sm-12 wow bounceInUp animate__animated animate__fadeInUp mb-5 text-dark" data-wow-delay="0.1s">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 wow bounceInUp animate__animated animate__fadeInUp mb-5 text-dark" data-wow-delay="0.3s">
                <div class="bg-light service-item">
                    <div class="service-content d-flex flex-column p-4 mb-5">
                        <div class="service-content-icon text-center">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 wow bounceInUp animate__animated animate__fadeInUp mb-5 text-dark" data-wow-delay="0.5s">
                <div class="bg-light service-item">
                    <div class="service-content d-flex flex-column p-4 mb-5" >
                        <div class="service-content-icon text-center">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 wow bounceInUp animate__animated animate__fadeInUp mb-5 text-dark" data-wow-delay="0.3s">
                <div class="bg-light service-item">
                    <div class="service-content d-flex flex-column p-4 mb-5">
                        <div class="service-content-icon text-center">
                            <FontAwesomeIcon icon={faBezierCurve} className="custom-icon" />
